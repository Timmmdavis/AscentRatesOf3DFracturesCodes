...
Mesh = CartesianMesh(steprad*xlength, steprad*ylength, int(xlength*30),  int(ylength*30)) 
...
Solid = MaterialProperties(Mesh,
                           ...
                           minimum_width=maxaperture/1000, 
                           free_surf=0,
...
totaltime= t_end*3; #Arbitary large value
...
## NEW! 31/8/22
#Scheme- see Explicit versus implicit front advancing schemes for thesimulation of hydraulic fracture growth
simulProp.frontAdvancing = ‘predictor-corrector’     # use 'explicit'/'implicit' front advancing algorithm - default is ‘predictor-corrector’
